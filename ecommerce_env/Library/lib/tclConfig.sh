...
# installed.
TCL_PREFIX='E:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library\include'
...
TCL_PACKAGE_PATH='E:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/Automated-E-Commerce-Funnel-Analysis-Business-Intelligence-Pipeline/ecommerce_env\Library\lib\tclstub86.lib'
